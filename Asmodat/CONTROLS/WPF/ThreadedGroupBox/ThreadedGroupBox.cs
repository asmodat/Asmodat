...
{
    public partial class ThreadedGroupBox : GroupBox
    {
        ...
        {
            get { return this.TryInvokeMethodFunction(() => { return base.Header; }); }
            set { this.TryInvokeMethodAction(() => { base.Header = value; }); }
        }
